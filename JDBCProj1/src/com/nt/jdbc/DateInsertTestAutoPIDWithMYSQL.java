...
/*SQL> create table person_tab (pid int(5) primary key AutoIncrement,pname varchar(20),DOB date,DOJ Date,DOM Date); */


public class DateInsertTestAutoPIDWithMYSQL {
  private static final String DATE_INSERT_QUERY="INSERT INTO PERSON_TAB(PNAME,DOB,DOJ,DOM) VALUES(?,?,?,?)";
	public static void main(String[] args) {
		...
		try {
		  ...
		  if(sc!=null) {
			...
			/* //register JDBC driver s/w Class.forName("org.postgresql.Driver");
			 * //establish the connection
			 * con=DriverManager.getConnection("jdbc:postgresql:NTAJ992DB","postgres",
			 * "tiger");
			 */
